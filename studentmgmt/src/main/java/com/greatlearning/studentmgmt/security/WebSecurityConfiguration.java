...
import com.greatlearning.studentmgmt.service.UserDetailServiceImpl;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			.antMatchers("/students/list","/students/showFormForAdd","/student/save").hasAnyAuthority("ADMIN","USER")
